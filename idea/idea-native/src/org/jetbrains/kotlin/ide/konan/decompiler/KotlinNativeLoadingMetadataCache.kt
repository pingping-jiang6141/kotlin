...
class KotlinNativeLoadingMetadataCache : ApplicationComponent {
    ...
    // Use special CacheKey class instead of VirtualFile for cache key. Certain types of VirtualFiles (for example, obtained from JarFileSystem)
    ...
    private val packageFragmentCache = createConcurrentSoftValueMap<CacheKey, KonanProtoBuf.LinkDataPackageFragment>()
    private val moduleHeaderCache = createConcurrentSoftValueMap<CacheKey, KonanProtoBuf.LinkDataLibrary>()
